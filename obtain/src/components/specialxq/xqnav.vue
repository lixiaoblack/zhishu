<template>
    <div class="navbox">
        ...
        <div class="fixed" v-if="fixedb">
            已取消收藏
        </div>
        <div class="top" v-if="bom" @click="funb()"></div>
        <div class="bom" v-if="bom">
            <div class="bottom">
                <ul>
                    <li><img src="../../../static/tu/r/f/a8j.png"><span>微信</span></li>
