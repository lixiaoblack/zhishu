    ...
    <div>
        ...
        <div>
            ...
            <div class="zujian" v-for="(v,i) in AllClassIfy" :key="i+11111">
                <Allclassify :courseTitle="v.courseTitle" :courseTeacherIntro="v.courseTeacherIntro" :bookAuthor="v.bookAuthor" :courseId="v.courseId" :courseSprice="v.courseSprice" :url="v.courseImgurl" classify="课堂" @click.native="funb()"></Allclassify>
            </div>
